"""A django app which proxies HTTP for a subsection of the URL space to specified hosts.
It's used to relay HTTP API requests from external machines to machines on the art VLAN. 
"""
